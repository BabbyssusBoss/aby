...
<div id="bas">
    ...
    <div id="contenu" style="text-align: center;">
        ...
        <form action="cibleflood.php" method="post">
            <div class="form-input">

            <label for="qp">indiqué votre niveau de quete d'alliance :</label>
            <input type="int" id="qp" name="qp" value="3"> <br>
            <p>
                <label for="tma">votre tm :</label>
                <input type="int" id="tma" name="tma" value="0"> <br>
                <label for="tmd">tm du défenseur :</label>
                <input type="int" id="tmd" name="tmd" value="0"> <br>
